...
![Firmware API](https://img.shields.io/badge/Dev%20API-88.5-8b5cf6)
...
| 🛠️ | **Developer** | Dev API 88.5, JS Runner as an FAP, SDK archives, release validation, acceptance telemetry, and reproducible build metadata. |
...
| **Dev** | `t-dev-008-021` | Hardware checks and feature validation | [All releases](https://github.com/squazaryu/tumoflip/releases) |
...
```text
flipper-z-f7-update-t-dev-008-021.tgz
```

## Compatibility notes

- Target: Flipper Zero F7 (`target 7`).
- Firmware API: Dev `88.5`; immutable stable `v1.0.7` remains `88.4`.

...
- Firmware version: `t-dev-089-036-056`
- Firmware origin/fork: `tumoflip`
- Firmware API: `87.17`
- Target: Flipper Zero F7
- Release channel: `dev` development line
- Release package: `flipper-z-f7-update-t-dev-089-036-056.tgz`
...
| --- | --- | --- |
| Firmware identity | Reports itself as Unleashed. | Reports `firmware_version: t-dev-089-036-056` and `firmware_origin_fork: tumoflip`. |
...
| Build metadata | Uses upstream build metadata conventions. | Uses `t-dev-089-036-056` for the installed firmware version and release artifact suffix, while keeping `tumoflip` as the fork origin. |
...
- `flipper-z-f7-update-t-dev-089-036-056.tgz`
...
```text
dist/f7-C/flipper-z-f7-update-t-dev-089-036-056.tgz
```

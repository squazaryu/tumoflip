...
![Firmware API](https://img.shields.io/badge/Dev%20API-88.11-8b5cf6)
...
| 🛠️ | **Developer** | Dev API 88.11, JS Runner as an FAP, SDK archives, release validation, acceptance telemetry, and reproducible build metadata. |
...
- Firmware API: Dev `88.11`; immutable stable `v1.0.8` remains `88.7`.

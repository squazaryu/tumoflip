...
![Firmware API](https://img.shields.io/badge/Dev%20API-88.6-8b5cf6)
...
| 🛠️ | **Developer** | Dev API 88.6, JS Runner as an FAP, SDK archives, release validation, acceptance telemetry, and reproducible build metadata. |
...
| **Dev** | `t-dev-008-022` | Hardware checks and feature validation | [All releases](https://github.com/squazaryu/tumoflip/releases) |
...
```text
flipper-z-f7-update-t-dev-008-022.tgz
```

## Compatibility notes

- Target: Flipper Zero F7 (`target 7`).
- Firmware API: Dev `88.6`; immutable stable `v1.0.7` remains `88.4`.

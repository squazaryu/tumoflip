...
| **Dev** | `t-dev-008-007` | Hardware checks and feature validation | [All releases](https://github.com/squazaryu/tumoflip/releases) |
...
```text
flipper-z-f7-update-t-dev-008-007.tgz
```

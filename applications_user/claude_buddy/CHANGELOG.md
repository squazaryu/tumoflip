...
- Rebuilt for Tumoflip firmware API 88.0.
- Standardized on Bridge transport for iOS Companion passthrough.
- Added Bridge transcript logging and session-token status.
- Fixed bounded transcript concatenation under strict compiler checks.
- Added the app to the Tumoflip Base FW package.

...
struct EspFlasherApp {
    ...
    char bin_file_path_boot[ESP_FLASH_PACKAGE_PATH_MAX];
    char bin_file_path_part[ESP_FLASH_PACKAGE_PATH_MAX];
    char bin_file_path_nvs[ESP_FLASH_PACKAGE_PATH_MAX];
    char bin_file_path_boot_app0[ESP_FLASH_PACKAGE_PATH_MAX];
    char bin_file_path_app_a[ESP_FLASH_PACKAGE_PATH_MAX];
    char bin_file_path_app_b[ESP_FLASH_PACKAGE_PATH_MAX];
    char bin_file_path_custom[ESP_FLASH_PACKAGE_PATH_MAX];

    bool package_mode;
    EspFlashPackagePlan package_plan;
    char package_path[ESP_FLASH_PACKAGE_PATH_MAX];
    char package_directories[ESP_FLASH_PACKAGE_MAX_DIRECTORIES]
                            [ESP_FLASH_PACKAGE_DIRECTORY_MAX];
    size_t package_directory_count;
    char package_summary[640];

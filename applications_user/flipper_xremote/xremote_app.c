...
void xremote_app_buttons_set_remote_type(XRemoteAppButtons* buttons, XRemoteRemoteType remote_type) {
    xremote_app_assert_void(buttons);
    if(remote_type >= XRemoteRemoteTypeCount) remote_type = XRemoteRemoteTypeGeneric;

    buttons->remote_type = remote_type;

    switch(remote_type) {
    case XRemoteRemoteTypeTV:
        furi_string_set_str(buttons->custom_ok, XREMOTE_COMMAND_POWER);
        furi_string_set_str(buttons->custom_up, XREMOTE_COMMAND_NEXT_CHAN);
        furi_string_set_str(buttons->custom_down, XREMOTE_COMMAND_PREV_CHAN);
        furi_string_set_str(buttons->custom_left, XREMOTE_COMMAND_VOL_DOWN);
        furi_string_set_str(buttons->custom_right, XREMOTE_COMMAND_VOL_UP);
        furi_string_set_str(buttons->custom_ok_hold, XREMOTE_COMMAND_MUTE);
        furi_string_set_str(buttons->custom_up_hold, XREMOTE_COMMAND_POWER);
        furi_string_set_str(buttons->custom_down_hold, XREMOTE_COMMAND_MUTE);
        furi_string_set_str(buttons->custom_left_hold, XREMOTE_COMMAND_PREV_CHAN);
        furi_string_set_str(buttons->custom_right_hold, XREMOTE_COMMAND_NEXT_CHAN);
        break;
    case XRemoteRemoteTypeAudio:
        furi_string_set_str(buttons->custom_ok, XREMOTE_COMMAND_PLAY);
        furi_string_set_str(buttons->custom_up, XREMOTE_COMMAND_VOL_UP);
        furi_string_set_str(buttons->custom_down, XREMOTE_COMMAND_VOL_DOWN);
        furi_string_set_str(buttons->custom_left, XREMOTE_COMMAND_JUMP_BACKWARD);
        furi_string_set_str(buttons->custom_right, XREMOTE_COMMAND_JUMP_FORWARD);
        furi_string_set_str(buttons->custom_ok_hold, XREMOTE_COMMAND_PAUSE);
        furi_string_set_str(buttons->custom_up_hold, XREMOTE_COMMAND_POWER);
        furi_string_set_str(buttons->custom_down_hold, XREMOTE_COMMAND_MUTE);
        furi_string_set_str(buttons->custom_left_hold, XREMOTE_COMMAND_JUMP_BACKWARD);
        furi_string_set_str(buttons->custom_right_hold, XREMOTE_COMMAND_JUMP_FORWARD);
        break;
    case XRemoteRemoteTypeProjector:
        furi_string_set_str(buttons->custom_ok, XREMOTE_COMMAND_POWER);
        furi_string_set_str(buttons->custom_up, XREMOTE_COMMAND_VOL_UP);
        furi_string_set_str(buttons->custom_down, XREMOTE_COMMAND_VOL_DOWN);
        furi_string_set_str(buttons->custom_left, XREMOTE_COMMAND_PLAY);
        furi_string_set_str(buttons->custom_right, XREMOTE_COMMAND_PAUSE);
        furi_string_set_str(buttons->custom_ok_hold, XREMOTE_COMMAND_MUTE);
        furi_string_set_str(buttons->custom_up_hold, XREMOTE_COMMAND_POWER);
        furi_string_set_str(buttons->custom_down_hold, XREMOTE_COMMAND_MUTE);
        furi_string_set_str(buttons->custom_left_hold, XREMOTE_COMMAND_PLAY);
        furi_string_set_str(buttons->custom_right_hold, XREMOTE_COMMAND_PAUSE);
        break;
    case XRemoteRemoteTypeLEDs:
        furi_string_set_str(buttons->custom_ok, XREMOTE_COMMAND_POWER_ON);
        furi_string_set_str(buttons->custom_up, XREMOTE_COMMAND_BRIGHTNESS_UP);
        furi_string_set_str(buttons->custom_down, XREMOTE_COMMAND_BRIGHTNESS_DN);
        furi_string_set_str(buttons->custom_left, XREMOTE_COMMAND_RED);
        furi_string_set_str(buttons->custom_right, XREMOTE_COMMAND_GREEN);
        furi_string_set_str(buttons->custom_ok_hold, XREMOTE_COMMAND_POWER_OFF);
        furi_string_set_str(buttons->custom_up_hold, XREMOTE_COMMAND_WHITE);
        furi_string_set_str(buttons->custom_down_hold, XREMOTE_COMMAND_BLUE);
        furi_string_set_str(buttons->custom_left_hold, XREMOTE_COMMAND_RED);
        furi_string_set_str(buttons->custom_right_hold, XREMOTE_COMMAND_GREEN);
        break;
    case XRemoteRemoteTypeFan:
        furi_string_set_str(buttons->custom_ok, XREMOTE_COMMAND_POWER);
        furi_string_set_str(buttons->custom_up, XREMOTE_COMMAND_SPEED_UP);
        furi_string_set_str(buttons->custom_down, XREMOTE_COMMAND_SPEED_DN);
        furi_string_set_str(buttons->custom_left, XREMOTE_COMMAND_ROTATE);
        furi_string_set_str(buttons->custom_right, XREMOTE_COMMAND_MODE);
        furi_string_set_str(buttons->custom_ok_hold, XREMOTE_COMMAND_TIMER);
        furi_string_set_str(buttons->custom_up_hold, XREMOTE_COMMAND_POWER);
        furi_string_set_str(buttons->custom_down_hold, XREMOTE_COMMAND_TIMER);
        furi_string_set_str(buttons->custom_left_hold, XREMOTE_COMMAND_ROTATE);
        furi_string_set_str(buttons->custom_right_hold, XREMOTE_COMMAND_MODE);
        break;
    case XRemoteRemoteTypeAC:
        furi_string_set_str(buttons->custom_ok, XREMOTE_COMMAND_POWER);
        furi_string_set_str(buttons->custom_up, XREMOTE_COMMAND_TEMP_UP);
        furi_string_set_str(buttons->custom_down, XREMOTE_COMMAND_TEMP_DOWN);
        furi_string_set_str(buttons->custom_left, XREMOTE_COMMAND_SUPER);
        furi_string_set_str(buttons->custom_right, XREMOTE_COMMAND_FAN_SPEED);
        furi_string_set_str(buttons->custom_ok_hold, XREMOTE_COMMAND_MODE);
        furi_string_set_str(buttons->custom_up_hold, XREMOTE_COMMAND_SMART);
        furi_string_set_str(buttons->custom_down_hold, XREMOTE_COMMAND_SLEEP);
        furi_string_set_str(buttons->custom_left_hold, XREMOTE_COMMAND_I_FEEL);
        furi_string_set_str(buttons->custom_right_hold, XREMOTE_COMMAND_SWING_V);
        break;
    case XRemoteRemoteTypeGeneric:
    default:
        furi_string_set_str(buttons->custom_up, XREMOTE_COMMAND_UP);
        furi_string_set_str(buttons->custom_down, XREMOTE_COMMAND_DOWN);
        furi_string_set_str(buttons->custom_left, XREMOTE_COMMAND_LEFT);
        furi_string_set_str(buttons->custom_right, XREMOTE_COMMAND_RIGHT);
        furi_string_set_str(buttons->custom_ok, XREMOTE_COMMAND_OK);
        furi_string_set_str(buttons->custom_up_hold, XREMOTE_COMMAND_INPUT);
        furi_string_set_str(buttons->custom_down_hold, XREMOTE_COMMAND_SETUP);
        furi_string_set_str(buttons->custom_left_hold, XREMOTE_COMMAND_MENU);
        furi_string_set_str(buttons->custom_right_hold, XREMOTE_COMMAND_LIST);
        furi_string_set_str(buttons->custom_ok_hold, XREMOTE_COMMAND_POWER);
        break;
    }
}
...
bool xremote_app_extension_load(XRemoteAppButtons* buttons, FuriString* path) {
    ...
    do {
        ...
        if(flipper_format_read_string(ff, "remote_type", tmp)) {
            xremote_app_buttons_set_remote_type(
                buttons, xremote_remote_type_from_name(furi_string_get_cstr(tmp)));
            remote_type_loaded = true;
        }
        flipper_format_rewind(ff);

        if(flipper_format_read_string(ff, "custom_ok", tmp)) {
            furi_string_set(buttons->custom_ok, tmp);
            custom_loaded = true;
        }

        if(flipper_format_read_string(ff, "custom_up", tmp)) {
            furi_string_set(buttons->custom_up, tmp);
            custom_loaded = true;
        }

        if(flipper_format_read_string(ff, "custom_down", tmp)) {
            furi_string_set(buttons->custom_down, tmp);
            custom_loaded = true;
        }

        if(flipper_format_read_string(ff, "custom_left", tmp)) {
            furi_string_set(buttons->custom_left, tmp);
            custom_loaded = true;
        }

        if(flipper_format_read_string(ff, "custom_right", tmp)) {
            furi_string_set(buttons->custom_right, tmp);
            custom_loaded = true;
        }

        if(flipper_format_read_string(ff, "custom_ok_hold", tmp)) {
            furi_string_set(buttons->custom_ok_hold, tmp);
            custom_loaded = true;
        }

        if(flipper_format_read_string(ff, "custom_up_hold", tmp)) {
            furi_string_set(buttons->custom_up_hold, tmp);
            custom_loaded = true;
        }

        if(flipper_format_read_string(ff, "custom_down_hold", tmp)) {
            furi_string_set(buttons->custom_down_hold, tmp);
            custom_loaded = true;
        }

        if(flipper_format_read_string(ff, "custom_left_hold", tmp)) {
            furi_string_set(buttons->custom_left_hold, tmp);
            custom_loaded = true;
        }

        if(flipper_format_read_string(ff, "custom_right_hold", tmp)) {
            furi_string_set(buttons->custom_right_hold, tmp);
            custom_loaded = true;
        }

        success = remote_type_loaded || custom_loaded;
    } while(false);
...
static XRemoteRemoteType xremote_app_buttons_infer_remote_type(InfraredRemote* remote) {
    XRemoteRemoteType best_type = XRemoteRemoteTypeGeneric;
    uint32_t best_matches = 0;

    for(uint32_t type = XRemoteRemoteTypeTV; type < XRemoteRemoteTypeCount; type++) {
        uint32_t matches = 0;
        const uint32_t button_count = xremote_remote_type_get_button_count(type);

        for(uint32_t i = 0; i < button_count; i++) {
            const char* button_name = xremote_remote_type_get_button_name(type, i);
            if(infrared_remote_get_button_by_name(remote, button_name)) matches++;
        }
    ...
    return best_matches >= 2 ? best_type : XRemoteRemoteTypeGeneric;
}
...
bool xremote_app_extension_store(XRemoteAppButtons* buttons, FuriString* path) {
    ...
    do {
        ...
        if(!flipper_format_write_string_cstr(
               ff, "remote_type", xremote_remote_type_get_name(buttons->remote_type)))
            break;
...
bool xremote_app_alt_names_check_and_init() {
    ...
    do {
        ...
        if(!flipper_format_write_string_cstr(ff, "Off", "poweroff,off,stop")) break;
        if(!flipper_format_write_string_cstr(ff, "Dh", "dry,dehumidify")) break;
        if(!flipper_format_write_string_cstr(ff, "Cool_hi", "coolhigh,cool_hi,cool+")) break;
        if(!flipper_format_write_string_cstr(ff, "Cool_lo", "coollow,cool_lo,cool-")) break;
        if(!flipper_format_write_string_cstr(ff, "Heat_hi", "heathigh,heat_hi,heat+")) break;
        if(!flipper_format_write_string_cstr(ff, "Heat_lo", "heatlow,heat_lo,heat-")) break;
        if(!flipper_format_write_string_cstr(ff, "Power_on", "on,poweron")) break;
        if(!flipper_format_write_string_cstr(ff, "Power_off", "off,poweroff")) break;
        if(!flipper_format_write_string_cstr(ff, "Brightness_up", "bright+,brightness+")) break;
        if(!flipper_format_write_string_cstr(ff, "Brightness_dn", "bright-,brightness-")) break;
        if(!flipper_format_write_string_cstr(ff, "Speed_up", "speed+,fan+")) break;
        if(!flipper_format_write_string_cstr(ff, "Speed_dn", "speed-,fan-")) break;
        if(!flipper_format_write_string_cstr(ff, "Rotate", "swing,oscillate")) break;
        if(!flipper_format_write_string_cstr(ff, "Smart", "auto,smart")) break;
        if(!flipper_format_write_string_cstr(ff, "Temp_up", "temp+,temperature+,t+")) break;
        if(!flipper_format_write_string_cstr(ff, "Temp_dn", "temp-,temperature-,t-")) break;
        if(!flipper_format_write_string_cstr(ff, "Super", "turbo,boost,jet")) break;
        if(!flipper_format_write_string_cstr(ff, "Fan_speed", "fan,fan_speed,fan speed")) break;
        if(!flipper_format_write_string_cstr(ff, "I_feel", "ifeel,i feel,follow")) break;
        if(!flipper_format_write_string_cstr(ff, "Sleep", "night,sleep")) break;
        if(!flipper_format_write_string_cstr(ff, "Swing_v", "swing,swingv,swing_v")) break;
        if(!flipper_format_write_string_cstr(ff, "Swing_h", "swingh,swing_h")) break;
        if(!flipper_format_write_string_cstr(ff, "Clock", "time,clock")) break;
        if(!flipper_format_write_string_cstr(ff, "Timer_on", "timeron,timer_on")) break;
        if(!flipper_format_write_string_cstr(ff, "Timer_off", "timeroff,timer_off")) break;
        if(!flipper_format_write_string_cstr(ff, "Quiet", "silent,quiet")) break;
        if(!flipper_format_write_string_cstr(ff, "Dimmer", "display,light,dimmer")) break;
        if(!flipper_format_write_string_cstr(ff, "Economy", "eco,economy,econo")) break;
...
XRemoteAppButtons* xremote_app_buttons_alloc() {
    ...
    buttons->remote_type = XRemoteRemoteTypeGeneric;
...
XRemoteAppButtons* xremote_app_buttons_load(XRemoteAppContext* app_ctx) {
    ...
    /* Load custom buttons from the selected path or infer layout for plain .ir files */
    if(!xremote_app_extension_load(buttons, app_ctx->file_path)) {
        xremote_app_buttons_set_remote_type(
            buttons, xremote_app_buttons_infer_remote_type(buttons->remote));
    }
    return buttons;
}

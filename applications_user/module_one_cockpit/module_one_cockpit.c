...
typedef enum {
    ...
    ModuleOneCockpitActionLaunchUartFieldConsole,
    ...
    ModuleOneCockpitActionLaunchRuntimeTrace,
...
static const ModuleOneCockpitMenuItem module_one_cockpit_menu[] = {
    ...
    {"UART: Field Console", ModuleOneCockpitActionLaunchUartFieldConsole},
    ...
    {"Security: TumoKey", ModuleOneCockpitActionLaunchTumoKey},
    ...
    {"System: Runtime Trace", ModuleOneCockpitActionLaunchRuntimeTrace},
...
static const ModuleOneCockpitLaunchTarget module_one_cockpit_targets[] = {
    ...
    },
    {
        ...
        ModuleOneCockpitBlockModule,
        "TumoVM Peripherals",
        EXT_PATH("apps/Module One/Labs/tumovm_peripherals.fap"),
        NULL,
        true,
    },
    {
        ...
        ModuleOneCockpitBlockModule,
        "TumoFabric Node",
        EXT_PATH("apps/Module One/Labs/tumofabric_node.fap"),
        NULL,
        true,
    },
    {

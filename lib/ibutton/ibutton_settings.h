 ...
 *
 * A missing file uses the default targets. An unreadable, corrupt or unsupported file
 * disables all targets until explicitly configured again; the getter never changes the file.
 *

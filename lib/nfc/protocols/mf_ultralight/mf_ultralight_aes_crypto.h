...
bool mf_ultralight_aes_cmac(const uint8_t* key, const uint8_t* data, size_t len, uint8_t* mac);
...
// Constant-time byte comparison for authentication randoms and secure-messaging MACs.

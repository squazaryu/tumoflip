 ...
 * @return true after the worker opens and validates the RAW file; false if the
 *         file cannot be opened, its protocol cannot be read, startup times out,
 *         or a non-NULL radio name cannot be resolved
 */

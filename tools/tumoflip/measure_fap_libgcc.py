...
This is deliberately a read-only measurement tool. The API compatibility decision and the
``fap_exclude_libs=["gcc"]`` opt-in remain in the manifests and build configuration.
"""

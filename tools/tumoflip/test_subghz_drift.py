...
class SubGhzDriftTest(unittest.TestCase):
    ...
    def test_manifest_tracks_shared_surfaces_not_profile_forks(self) -> None:
        ...
        self.assertNotIn("helpers/subghz_frequency_analyzer_worker.c", entries)
        self.assertNotIn("helpers/subghz_frequency_analyzer_worker.h", entries)
        self.assertNotIn("scenes/subghz_scene_frequency_analyzer.c", entries)
        self.assertNotIn("views/subghz_frequency_analyzer.c", entries)
        self.assertNotIn("views/subghz_frequency_analyzer.h", entries)
